...
canvas = tk.Canvas(bg='#000000', bd=0, highlightthickness=0)
...
tk.Label(canvas, text='GUI Calculator', anchor='e', bg='#272533', fg='white', font=('Franklin Gothic Book', 14, 'bold')).grid(row=0, columnspan=4, sticky='ew', padx=4, pady=2)
